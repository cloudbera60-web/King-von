                        ...
                        res.send(`
                            ...
                            <body>
                                <div class="container">
                                    ...
                                    <p style="color: #8a2be2; font-weight: bold; font-size: 14px;">
                                        ⚡ Bot will start automatically after successful connection
                                    </p>
                    ...
                    if (sessionData) {
                        try {
                            ...
                            if (sessionData && sessionData.length > 100) {
                                ...
                                // Optional: Notify any external service or restart bot process
                                // For now, just log success
                                console.log("✅ Bot session saved. Bot should auto-start if running.");
                                
                                await delay(3000);
                                await Gifted.ws.close();
                            }
                        } catch (sendError) {
                            console.error("Error processing session:", sendError);
                            // Still send message to user
                            try {
                                await Gifted.sendMessage(Gifted.user.id, {
                                    text: `✅ Connected successfully!\n\n` +
